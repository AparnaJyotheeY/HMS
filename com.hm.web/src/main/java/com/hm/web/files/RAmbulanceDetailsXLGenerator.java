...
public class RAmbulanceDetailsXLGenerator extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workBook, HttpServletRequest req,
        ...
        for (ReceptionistBean alist : amb) {
            ...
            aRow.createCell(4).setCellValue(alist.getIntime());
            aRow.createCell(5).setCellValue(alist.getStatus());
