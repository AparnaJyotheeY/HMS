...
public class PatientDetailsXLGenerator extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workBook, HttpServletRequest req,
			HttpServletResponse resp) throws Exception {
	
		List<DoctorBean> patient = (List<DoctorBean>) model.get("patient");
		
		// create a new Excel sheet
        HSSFSheet sheet = workBook.createSheet("Patient List");
        ...
        header.createCell(0).setCellValue("Pid");
        ...
        header.createCell(6).setCellValue("bloodgroup");
        ...
        for (DoctorBean dlist : patient) {
            ...
            aRow.createCell(0).setCellValue(dlist.getPid());
            ...
            aRow.createCell(6).setCellValue(dlist.getBloodgroup());
            aRow.createCell(7).setCellValue(dlist.getAge());
