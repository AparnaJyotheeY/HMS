...
public class NurseDetailsXLGenerator  extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workBook, HttpServletRequest req,
			HttpServletResponse resp) throws Exception {
	
		List<DoctorBean> nurse = (List<DoctorBean>) model.get("nurse");
		
		// create a new Excel sheet
        HSSFSheet sheet = workBook.createSheet("Nurse List");
