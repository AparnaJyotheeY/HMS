...
<div class="row">
<div class="col-md-6"><h3> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&nbsp;&nbsp; Requested Appointment</h3></div>
</div>
...
<div class="well table-responsive">
    ...
    <td></td>
<td></td>
    <td><a data-placement="top" data-toggle="tooltip" title="Approve"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span> Approve</button></a></td>
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Approve Appointment</h4>
         ...
         <div class="modal-body">
          <form:form action="approveapp" method="post" class="form-horizontal" modelAttribute="userRegDetails" >
									...
									<ul id="menu" >
									 ...
									 <li class="active"><a href="#"><i class="fa fa-edit" aria-hidden="true"></i><span> Appointment</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   ...
										   <li><a href="receptionistappointmentlist.html">Appointment List</a></li>
											<li class="active" ><a href="receptionistrequestedapp.html">Requested Appointment</a></li>
