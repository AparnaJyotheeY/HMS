...
List<DoctorBean> dlist=(List) request.getAttribute("pharmacistlist");
...
<div class="col-md-6"><h3> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&nbsp;&nbsp; Pharmacist</h3></div>
<div class="col-md-offset-9 col-md-3"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#add">Add Pharmacist</button></div>
...
<div class="well  table-responsive">
    ...
    <td><%=dbean.getPhone() %></td>
      ...
      <td><a data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" onclick="opendialog('<%=dbean.getNurseid() %>~<%=dbean.getName()%>~<%=dbean.getEmail() %>~<td><%=dbean.getAddress() %>~<%=dbean.getPhone() %>')" ><span class="glyphicon glyphicon-pencil"></span></button></a>
    <a data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" onclick="opendeldialog('<%=dbean.getEmail() %>')"><span class="glyphicon glyphicon-trash"></span></button></a></td>
    </tr>
  <%} %>
    </tbody>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Edit Pharmacist</h4>
      </div>
		  
          <div class="modal-body">
                  <form:form action="pharmacistupdate" class="form-horizontal"  >
		  <div class="col-md-offset-1 col-md-10">
         
		 <div class="form-group">
        <input class="form-control " id="enid" name="epid" type="text" placeholder="Pharmacist Id" readonly>
        </div>
        
		 <div class="form-group">
        <input class="form-control " id="ename" name="ename" type="text" placeholder="Name" >
        </div>
		
        <div class="form-group">
        
        <input class="form-control " id="eemail" name="eemail" type="text" placeholder="Email" readonly>
        </div>
	
		
		<div class="form-group">
        
        <input class="form-control " id="eaddr" name="eaddress" type="text" placeholder="Address">
        </div>
		
      <div class="form-group">
        
        <input class="form-control " id="ephone" name="ephone" type="text" placeholder="Phone">
        </div>

		<div class="form-group">
        <label>Image</label>
        <input class="form-control " id="eimage" name="eimage" type="file" placeholder="Image">
        </div>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Record?</div>
        ...
        <div class="modal-footer ">
          <form:form action="pharmacistdelete" class="form-horizontal"  >
          <div>
         <div>
       <input type="hidden" id="demail" name="demail">
      </div>
        <button type="submit" class="btn btn-success" onclick="location.href='pharmacistdelete'" ><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
        </div>
         </form:form>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
          <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title custom_align" id="Heading">Add Pharmacist</h4>
      </div>
                    <form:form action="pharmacistdetails" method="post" class="form-horizontal" enctype="multipart/form-data" modelAttribute="userRegDetails" >
			...
			<div class="sidebar-menu"style="height:1050px; position:absolute;">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="<%=request.getContextPath( )%>/admin"><i class="fa fa-desktop"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
									 ...
									 <li id="menu-academico" ><a href="<%=request.getContextPath( )%>/addnurse"><i class="fa fa-user " aria-hidden="true"></i><span> Patient</span> <div class="clearfix"></div></a></li>
									
									<li id="menu-academico" ><a href="<%=request.getContextPath( )%>/addnurse"><i class="fa fa-plus-square" aria-hidden="true"></i><span>Nurse</span><div class="clearfix"></div></a></li>
									 
									 <li class="active"><a href="<%=request.getContextPath( )%>/addpharmacist"><i class="fa fa-medkit" aria-hidden="true"></i><span>Pharmacist</span> <div class="clearfix"></div></a>
