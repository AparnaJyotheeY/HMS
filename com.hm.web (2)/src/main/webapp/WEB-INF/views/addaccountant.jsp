...
List<DoctorBean> dlist=(List) request.getAttribute("accountantlist");
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="images/.jpg" alt="img"> </span> 
												<div class="user-name">
													<p>Name</p>
												</div>
...
<div class="col-md-6"><h3> <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>&nbsp;&nbsp; Accountant</h3></div>
<div class="col-md-offset-9 col-md-3"><button type="button" class="btn btn-success" data-toggle="modal" data-target="#add">Add Accountant</button></div>
                       <span> <h4 style="color:red;text-align:center"><%=message %></h4><h4 style="color:green;text-align:center"><%=smessage %></h4></span>

<div class="btn-toolbar">
     <button class="btn btn-primary">Copy</button>
    
    <button onclick="location.href='./exportaexcel'" class="btn btn-warning">Excel</button>
    <button onclick="location.href='./exportapdf'" class="btn btn-danger">PDF</button>
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Edit Nurse</h4>
          ...
          <div class="modal-body">
                            <form:form action="aupdate" class="form-horizontal"  >
          
		  <div class="col-md-offset-1 col-md-10">
         
          <div class="form-group">
        <input class="form-control " id="enid" name="enid" type="text" placeholder="Nurse Id" readonly>
        </div>
    ...
    <div class="modal-content">
       ...
       <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Record?</div>
        ...
        <div class="modal-footer ">
          ...
          <form:form action="adelete" class="form-horizontal"  >
          <div>
         <div>
       <input type="hidden" id="demail" name="demail">
      </div>
        <button type="submit" class="btn btn-success" onclick="location.href='ndelete'" ><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
        </div>
         </form:form>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Add Nurse</h4>
              ...
              <form:form action="accountantdetails" method="post" class="form-horizontal" enctype="multipart/form-data" modelAttribute="userRegDetails" >
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li class="active"><a href="adaccount.html"><i class="fa fa-money" aria-hidden="true"></i><span>Accountant</span> <div class="clearfix"></div></a>
									  
									</li>
									
									<li><a href="adreceptionist.html"><i class="fa fa-plus-square"></i>  <span>Receptionist</span><div class="clearfix"></div></a></li>
									<li id="menu-academico" ><a href=""><i class="fa fa-cog" aria-hidden="true"></i><span>Monitor Hospital</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
