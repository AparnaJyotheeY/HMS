...
public class AccountantDetailsXLGenerator  extends AbstractExcelView {

	@Override
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workBook, HttpServletRequest req,
			HttpServletResponse resp) throws Exception {
	
		List<DoctorBean> nurse = (List<DoctorBean>) model.get("accountant");
		
		// create a new Excel sheet
        HSSFSheet sheet = workBook.createSheet("Accountant List");
        ...
        header.createCell(0).setCellValue("Accountant Id");
